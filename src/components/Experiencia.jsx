    ...
    <section id='experiencia' className="max-w-7xl mx-auto px-8 py-24 bg-[#050810]">
      <div className="flex flex-col items-center mb-16 text-center">
        <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter">
          TRAYECTORIA <span className="text-emerald-500">HÍBRIDA</span>
        </h2>
        ...
        <p className="mt-6 text-slate-400 max-w-2xl text-lg">
          Combinando el rigor del análisis contable con la empatía de la atención al público y la potencia del desarrollo de sistemas.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="group perspective-1000">
          <div className="relative h-full bg-slate-900/40 border border-white/10 rounded-[2.5rem] p-10 transition-all duration-500 ease-out 
            ...
            <h3 className="text-2xl font-bold text-white mb-2">Customer Success & UX</h3>
            <p className="text-blue-400 font-semibold mb-6">Minimercado "Miguelo" </p>
